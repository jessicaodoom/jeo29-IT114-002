    ...
    private void processPayload(Payload p) {
        ...
        switch (p.getPayloadType()) {
            ...
            case EXPORT:
                // UCID: jeo29
                // Date: Appril 27, 2024
                events.exportMessage();
                break;
            case MUTE:
                // UCID: jeo29
                // Date: April 27, 2024
                events.onMuteUser(p.getMutedClientID(),"<font color =\"gray\">" + p.getClientName() + " ("+p.getMutedClientID()+")" + "</font>");
                events.onMessageReceive(p.getClientId(), "<font color =\"red\">" + p.getClientName() + " has been muted</font>");
                break;
            case UNMUTE:
                // UCID: jeo29
                // April 27, 2024
                events.onUnMuteUser(p.getMutedClientID(),"<font color =\"black\">" + p.getClientName() + " ("+p.getMutedClientID()+")" + "</font>");
